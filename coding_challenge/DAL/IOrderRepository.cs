...
namespace coding_challenge.DAL
{
    public interface IOrderRepository : IDisposable
    {
        ...
        Task<(IEnumerable<Order> Orders, int totalCount)> FilterOrdersAsync(string? customerQuery, OrderType? type, string? startDate, string? endDate, int page, int pageSize);
